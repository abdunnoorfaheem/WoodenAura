  ...
  return (
    <section>
        ...
        <div className="container mx-auto md:flex justify-between mt-6">
            ...
            {filterData.map((item)=>(
                <div className='md:w-[32%] max-h-[645px] mb-8  shadow-2xl group'>
                <div className='flex justify-center py-6 '>
                    <img className='bg-[#F6F7FB] p-6 rounded-full group-hover:border-b-[10px] group-hover:border-purple-500 group-hover:rotate-90 duration-500 ease-in-out' src={item.thumbnail} alt="" />
                </div>
