...
const TrendingProducts = () => {
  ...
  let filtered = data.filter((item) => item.id >= 11 && item.id <= 14);

  return (
    <section className="mt-4 mb-4">
      <h2 className="text-2xl text-center md:text-4xl font-bold text-[#151875]">
        Trending Products
      </h2>
        ...
        {filtered.map((item) => (
          <div className=" md:w-[24%]">
            <div className=" shadow-lg  rounded">
              ...
              <div className=" py-5">
                <h3 className="text-center font-bold text-[#151875]">
                  {item.title}
                </h3>
      ...
      <div className="container mx-auto md:flex justify-evenly mt-12">
        <div className='md:w-[24%] h-[270px] bg-[url("./assets/clock.png")] bg-cover shadow-2xl bg-[#FFF6FB] px-6 py-6'>
          <h2 className="text-[22px] font-semibold text-[#151875]">
        ...
        <div className='md:w-[24%] h-[270px] bg-[url("./assets/bar.png")] bg-cover shadow-2xl bg-[#EEEFFB] px-6 py-6'>
          ...
          <p className="text-[#FB2E86] font-medium underline">
            View Collection
          </p>
        </div>
