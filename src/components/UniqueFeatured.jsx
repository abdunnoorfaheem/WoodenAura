    ...
    <section className="bg-[url('./assets/RectangleSofa.png')]">
      <div className="container mx-auto md:flex items-center">
        ...
        <div className="md:w-[50%]">
          ...
          <ul className=" text-[#ACABC3] mt-4">
            <li className="list-disc">All frames constructed with hardwood solids and laminates</li>
            <li className="list-disc">Reinforced with double wood dowels, glue, screw - nails corner  <br /> blocks and machine nails</li>
            <li className="list-disc">Arms, backs and seats are structurally reinforced</li>
          </ul>
